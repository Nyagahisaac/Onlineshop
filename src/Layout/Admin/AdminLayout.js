          ...
          <main>
            <div className="container-fluid px-4" >
              <div class="container pt-4">
                <section>
                  <h1 className="text-center p-2 mb-2">DATACOMP <img src="https://img.freepik.com/free-vector/letter-c-computer_1308-83159.jpg?size=626&ext=jpg" width="50" style={{ borderRadius: '20px' }} alt="" /> </h1>
                </section>
                <Outlet />
